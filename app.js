...
var incompleteTaskHolder = document.querySelector(".task__list_undone");//ul of #incompleteTasks
var completedTasksHolder = document.querySelector(".tasks__list_done");//completed-tasks
...
var createNewTaskElement = function (taskString) {
  ...
  listItem.className = "tasks__point";
  ...
  editInput.type = "text";
  editInput.className = "input input_edit";
...
var taskCompleted = function () {
  ...
  var listItem = this.parentNode;
  listItem.querySelector('.tasks__name').classList.add('tasks__name_done')
...
var taskIncomplete = function () {
  ...
  var listItem = this.parentNode;
  listItem.querySelector('.tasks__name').classList.remove('tasks__name_done')
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
}
